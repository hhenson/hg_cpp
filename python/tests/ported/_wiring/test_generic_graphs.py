...
# the module imports surfaces that are not landed yet - skip collection
# rather than error (the file is wip).
try:
    ...
    pytest.skip("gap: polars-based generic-graph cases pending triage", allow_module_level=True)
