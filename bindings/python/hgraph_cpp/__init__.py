"""hgraph_cpp - the hgraph API over the C++ runtime.
...
module-level function (via PEP 562 - `from hgraph_cpp import add_, const,
...
from ._runtime import WiringPort, graph, run_graph, eval_node, wire, operator_function
...
def __getattr__(name):
    if name in _OPERATOR_NAMES:
        ...
        return fn
    raise AttributeError(f"module 'hgraph_cpp' has no attribute '{name}'")
...
__all__ = [
    ...
    "WiringPort", "graph", "run_graph", "eval_node", "wire",
